...
g1 = gcmc(data = columbus,cause = "hoval",effect = "crime",E = c(6,8),k = 18)
g1

# household income and crime (residential burglaries and vehicle thefts)
g2 = gcmc(data = columbus,cause = "inc",effect = "crime",E = c(5,8),k = 18)
g2

# housing value and household income
g3 = gcmc(data = columbus,cause = "hoval",effect = "inc",E = c(6,5),k = 18)
g3
